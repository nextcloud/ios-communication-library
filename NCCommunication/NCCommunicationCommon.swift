...
@objc public class NCCommunicationCommon: NSObject {
    ...
    public func uploadComplete(fileName: String, serverUrl: String, ocId: String?, etag: String?, date: NSDate?, contentType: String?, size: Int64, description: String?, error: Error?, statusCode: Int) {
